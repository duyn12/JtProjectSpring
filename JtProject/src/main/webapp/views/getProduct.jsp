    ...
    <div class="container">
      <div class="form">
        <form action="#">
          ...
          <div class="continue">
            <input type="submit" value="Submit" type="button" value="continue" class="continue-button" />
          </div>
        </form>
      </div>
      ...
      <%
            ...
            <div class="product-info">
              ...
              <div class="product-price">
                <p class="dollar">
                  <span class="first-price"><%= rs.getInt(6) %></span>
              ...
              <div class="product-line-price"><%= rs.getInt(6) %></div>
            </div>
          </div>
				<%
				}
