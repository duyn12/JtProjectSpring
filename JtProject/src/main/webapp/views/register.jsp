        ...
        <form action="newuserregister" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control form-control-lg" required placeholder="Password*" required name="password"
                       id="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*?[~`!@#$%\^&*()\-_=+[\]{};:\x27.,\x22\\|/?><]).{8,}" title="Phải chứa:
                       ít nhất một số, một chữ thường, một ký tự đặc biệt và 8 ký tự trở lên" required> <small id="emailHelp" class="form-text text-muted">Phải chứa:
                       ít nhất một số, một chữ hoa, một chữ thường, một ký tự đặc biệt và 8 ký tự trở lên</small>
